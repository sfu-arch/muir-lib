...
class test03DF(implicit p: Parameters) extends test03DFIO()(p) {
  ...
  val binaryOp_a_addr_02 = Module(new ComputeNode(NumOuts = 1, ID = 2, opCode = "sub")(sign = false, Debug = true, GuardVal = -5)

  //  %sub1 = select i1 %cmp, i32 0, i32 %a, !dbg !21, !UID !24

  //  %b.addr.0 = sub nsw i32 %b, %sub1, !dbg !21, !UID !25
  val binaryOp_b_addr_04 = Module(new ComputeNode(NumOuts = 1, ID = 4, opCode = "sub")(sign = false, Debug = true, GuardVal = 5)
