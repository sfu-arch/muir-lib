...
class ComputeFuse03SDF(implicit val p: Parameters) extends Module
  with HasAccelParams
  with HasDebugCodes {
...
class ComputeFuse03PDF(implicit val p: Parameters) extends Module with HasAccelParams with HasDebugCodes {
