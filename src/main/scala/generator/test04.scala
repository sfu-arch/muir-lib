...
class test04DebugDF(ArgsIn: Seq[Int] = List(32, 32, 32), Returns: Seq[Int] = List(32))
  ...
  val phi4 = Module(new PhiFastNode(NumInputs = 2, NumOutputs = 1, ID = 4, Res = true , Debug = false))
